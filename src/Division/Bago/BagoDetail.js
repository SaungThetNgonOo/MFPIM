...
import BagoImgdata from "./BagoImgdata";
function BagoDetail({lag,log,setLog,login,setLogin,User,setUser,signUp,setSignUp,name,setName,email,setEmail}) {
...
function handleClick(i){
  ...
  // },[data])
  // console.log(data)
  const Place = BagoData.find((place) => place.name === placeName);
  console.log(Place);
  return (
    <div className="DivG">
      <Nav
