...
function YangonDetail({lag,log,setLog,login,setLogin,User,setUser,signUp,setSignUp,name,setName,email,setEmail}) {
  ...
  // },[data])
  // console.log(data)
  const Place = YangonData.find((place) => place.name === placeName);
  console.log(Place);
  return (
    <div className="DivG">
      <Nav log={log}login={login}setLogin={setLogin}User={User}setUser={setUser}/>
      {/* <div className="login">
        {login ?<Login login={login}setLogin={setLogin}User={User}setUser={setUser}setLog={setLog}lag={lag}signUp={signUp}
          setSignUp={setSignUp}name={name}setName={setName}email={email}setEmail={setEmail}/> :
        <div></div>
        }
        {signUp ? <SignUp login={login}setLogin={setLogin}User={User}setUser={setUser}setLog={setLog}lag={lag}
        signUp={signUp}setSignUp={setSignUp}name={name}setName={setName}email={email}setEmail={setEmail}/> :
        <div></div>
        }
      </div> */}
      <div className="Div">
        ...
        <div className="Bus">
          <span><RiBusFill/> Nearest Bus Stop</span>
          <div className="BusStop">
          <ul>{Place.YBS.map(i=>(
            <li><RiWalkLine className="walk"/>{i}</li>
          )
          )}
          </ul>
          </div>
