...
import MagwayImgdata from "./MagwayImgdata";

function MagwayDetail({lag,log,setLog,login,setLogin,User,setUser,signUp,setSignUp,name,setName,email,setEmail}) {
  ...
  // },[data])
  // console.log(data)
  const Place = MagwayData.find((place) => place.name === placeName);
  console.log(Place);
  return (
    <div className="DivG">
