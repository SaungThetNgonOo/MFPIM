...
import AyeImgdata from "./AyeImgdata";
function ADetail({lag,log,setLog,login,setLogin,User,setUser,signUp,setSignUp,name,setName,email,setEmail}) {
  ...
  // },[data])
  // console.log(data)
  const Place = AyeData.find((place) => place.name === placeName);
  console.log(Place);
  return (
    <div className="DivG">
      <Nav
