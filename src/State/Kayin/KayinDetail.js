...
import KayinImgdata from "./KayinImgdata";
function KayinDetail({lag,log,setLog,login,setLogin,User,setUser,signUp,setSignUp,name,setName,email,setEmail}) {
...
function handleClick(i){
  ...
  // },[data])
  // console.log(data)
  const Place = KayinData.find((place) => place.name === placeName);
  console.log(Place);
  return (
    <div className="DivG">
