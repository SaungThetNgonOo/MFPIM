...
import ShanImgdata from "./ShanImgdata";
function ShanDetail({lag,log,setLog,login,setLogin,User,setUser,signUp,setSignUp,name,setName,email,setEmail}) {
...
function handleClick(i){
  ...
  // },[data])
  // console.log(data)
  const Place = ShanData.find((place) => place.name === placeName);
  console.log(Place);
  return (
    <div className="DivG">
